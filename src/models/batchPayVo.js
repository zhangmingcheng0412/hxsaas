/*
import {getBatchPayVo, getOrderData} from '@/services/payment'

const BatchPayVoMode ={
    namespace: 'batchPayVo',
    state: {
        data: []
    },
    effects: {
        * batchPay({payload}, {call, put}) {
            const response = yield call(getBatchPayVo, payload);
